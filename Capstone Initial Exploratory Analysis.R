...
pairs(~Total.Discharges + Average.Covered.Charges + Average.Total.Payments + Average.Medicare.Payments + Poverty.Percent.County 
      + Median.Income.County + Unemployment.County + Density.County, data=medicare.pneumonia, 
